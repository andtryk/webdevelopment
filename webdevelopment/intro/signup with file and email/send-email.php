...
try {
    ...
    $mail->Username   = 'devtestkea@gmail.com';                     // SMTP username
    ...
    //Recipients
    $mail->setFrom('devtestkea@gmail.com', 'Fibi Kea');
    $mail->addAddress($_POST['email'] ?? 'devtestkea@gmail.com' , 'Fibi Kea');     // Add a recipient
    ...
    $mail->Subject = 'Twitter Clone';
    $_POST['fullName'] = $_POST['fullName'] ?? 'A AA';
    $mail->Body    = 'Welcome '.$_POST['fullName'].' to Twitter Clone';
